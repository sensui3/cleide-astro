...
description: "Sinais da Fobia Social- Relacionado a interações sociais ou de desempenho, pode ser marcado por sintomas físicos e levar a crises de pânico"
publishedAt: 2025-09-15T22:44:31.000Z
image: "/assets/blog/fobia-social.jpg"
category: "Psicóloga"
draft: false
---

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading" id="entendendo-a-fobia-social">Entendendo a Fobia Social</h1>
<!-- /wp:heading -->
...
<!-- wp:list -->
<ul class="wp-block-list"><!-- wp:list-item -->
<li>Identificar e questionar pensamentos negativos automáticos</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Desenvolver pensamentos mais realistas e equilibrados</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Praticar autocompaixão e reduzir a autocrítica excessiva</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:list -->
<ul class="wp-block-list"><!-- wp:list-item -->
<li>Criar uma hierarquia de situações temidas, do menos ao mais ansioso</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Expor-se gradualmente às situações, começando pelas menos desafiadoras</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Celebrar pequenos progressos e manter registros das conquistas</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:table -->
<figure class="wp-block-table"><table class="has-fixed-layout"><thead><tr><th>Sintomas Físicos</th><th>Sintomas Emocionais</th></tr></thead><tbody><tr><td>Sudorese excessiva</td><td>Medo de ser julgado</td></tr><tr><td>Tremores</td><td>Ansiedade intensa</td></tr><tr><td>Palpitações</td><td>Evitação de interações sociais</td></tr><tr><td>Crises de pânico</td><td>Isolamento social</td></tr></tbody></table></figure>
<!-- /wp:table -->
